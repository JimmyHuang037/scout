...
class TestTeacherEndpoints(CurlTestBase):
    ...
    def test_01_get_exam_classes(self):
        ...
        self.run_api_test(
            1, "教师获取任教班级列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/exam-classes', '|', 'jq'],
    ...
    def test_02_get_scores(self):
        ...
        self.run_api_test(
            2, "教师获取学生成绩列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/scores', '|', 'jq'],
            "2_get_scores.json",
            self.test_setup
        )
    ...
    def test_03_create_score(self):
        ...
        self.run_api_test(
            3, "教师创建学生成绩",
            ['curl', '-s', '-X', 'POST', f'{self.base_url}/api/teacher/T001/scores',
    ...
    def test_04_update_score_success(self):
        ...
        self.run_api_test(
            4, "教师更新学生成绩 - 正常情况",
            ['curl', '-s', '-X', 'PUT', f'{self.base_url}/api/teacher/T001/scores/1',
             '-H', 'Content-Type: application/json',
             '-d', '{"score": 92}',
             '|', 'jq'],
    ...
    def test_05_update_score_not_found(self):
        ...
        self.run_api_test(
            5, "教师更新学生成绩 - 更新不存在的成绩",
            ['curl', '-s', '-X', 'PUT', f'{self.base_url}/api/teacher/T001/scores/999',
             '-H', 'Content-Type: application/json',
             '-d', '{"score": 85}',
             '|', 'jq'],
    ...
    def test_07_delete_score(self):
        ...
        self.run_api_test(
            7, "教师删除学生成绩",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/teacher/T001/scores/1', '|', 'jq'],
            "7_delete_score.json",
            self.test_setup
        )
    ...
    def test_08_get_classes(self):
        ...
        self.run_api_test(
            8, "获取班级列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/classes', '|', 'jq'],
    ...
    def test_09_get_class_by_id(self):
        ...
        self.run_api_test(
            9, "根据ID获取班级",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/classes/1', '|', 'jq'],
    ...
    def test_10_get_class_not_found(self):
        ...
        self.run_api_test(
            10, "获取不存在的班级",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/classes/999', '|', 'jq'],
    ...
    def test_11_get_students(self):
        ...
        self.run_api_test(
            11, "教师获取学生列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/students', '|', 'jq'],
    ...
    def test_12_get_student_by_id(self):
        ...
        self.run_api_test(
            12, "教师根据ID获取学生",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/students/S0601', '|', 'jq'],
    ...
    def test_13_get_student_not_found(self):
        ...
        self.run_api_test(
            13, "教师获取不存在的学生",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/students/NOTEXIST', '|', 'jq'],
    ...
    def test_14_create_student(self):
        ...
        self.run_api_test(
            14, "教师创建学生",
            ['curl', '-s', '-X', 'POST', f'{self.base_url}/api/teacher/T001/students',
             '-H', 'Content-Type: application/json',
    ...
    def test_17_delete_student(self):
        ...
        self.run_api_test(
            17, "教师删除学生",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/teacher/T001/students/TEST001', '|', 'jq'],
    ...
    def test_18_update_student(self):
        ...
        self.run_api_test(
            18, "教师更新学生信息",
            ['curl', '-s', '-X', 'PUT', f'{self.base_url}/api/teacher/T001/students/S0601',
             '-H', 'Content-Type: application/json',
    ...
    def test_19_get_teachers(self):
        ...
        self.run_api_test(
            19, "教师获取教师列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/teachers', '|', 'jq'],
    ...
    def test_20_get_teacher(self):
        ...
        self.run_api_test(
            20, "教师获取特定教师信息",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/teachers/1', '|', 'jq'],
    ...
    def test_21_get_class_students(self):
        ...
        self.run_api_test(
            21, "教师获取班级学生列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/classes/1/students', '|', 'jq'],
    ...
    def test_22_get_exams(self):
        ...
        self.run_api_test(
            22, "教师获取考试列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/exams', '|', 'jq'],
    ...
    def test_23_get_exam_by_id(self):
        ...
        self.run_api_test(
            23, "教师获取特定考试信息",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/exams/1', '|', 'jq'],
    ...
    def test_24_create_exam(self):
        ...
        self.run_api_test(
            24, "教师创建考试",
            ['curl', '-s', '-X', 'POST', f'{self.base_url}/api/teacher/T001/exams',
             '-H', 'Content-Type: application/json',
    ...
    def test_25_update_exam(self):
        ...
        self.run_api_test(
            25, "教师更新考试信息",
            ['curl', '-s', '-X', 'PUT', f'{self.base_url}/api/teacher/T001/exams/1',
             '-H', 'Content-Type: application/json',
             '-d', '{"name": "更新的考试"}',
             '|', 'jq'],
    ...
    def test_26_delete_exam(self):
        ...
        self.run_api_test(
            26, "教师删除考试",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/teacher/T001/exams/1', '|', 'jq'],
    ...
    def test_27_get_exam_scores(self):
        ...
        self.run_api_test(
            27, "教师获取考试成绩列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/T001/exams/1/scores', '|', 'jq'],
