...
class TestTeacherEndpoints(CurlTestBase):
    ...
    def test_teacher_exam_type_endpoints(self, start_api_server, test_results_dir, curl_commands_file):
        ...
        self.run_api_test(
            21, "获取考试类型列表(教师)",
            ['curl', '-s', f'{self.base_url}/api/admin/exam-types', '-b', cookie_file],
        ...
        self.run_api_test(
            23, "获取特定考试类型",
            ['curl', '-s', f'{self.base_url}/api/admin/exam-types/1', '-b', cookie_file],
        ...
        self.run_api_test(
            25, "删除考试类型",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/admin/exam-types/1', '-b', cookie_file],
    ...
    def test_teacher_score_endpoints(self, start_api_server, test_results_dir, curl_commands_file):
        ...
        self.run_api_test(
            26, "教师获取任教班级列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/exam/classes', '-b', cookie_file],
        ...
        self.run_api_test(
            27, "教师获取学生成绩列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/scores', '-b', cookie_file],
        ...
        self.run_api_test(
            30, "教师删除学生成绩",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/teacher/scores/1', '-b', cookie_file],
    ...
    def test_teacher_exam_endpoints(self, start_api_server, test_results_dir, curl_commands_file):
        ...
        self.run_api_test(
            31, "教师获取考试列表",
            ['curl', '-s', f'{self.base_url}/api/teacher/exams', '-b', cookie_file],
        ...
        self.run_api_test(
            33, "教师获取特定考试",
            ['curl', '-s', f'{self.base_url}/api/teacher/exams/1', '-b', cookie_file],
        ...
        self.run_api_test(
            35, "教师删除考试",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/teacher/exams/1', '-b', cookie_file],
