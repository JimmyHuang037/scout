...
class TestAdminEndpoints(CurlTestBase):
    ...
    def test_08_get_teacher(self):
        ...
        self.run_api_test(
            8, "获取特定教师",
            ['curl', '-s', f'{self.base_url}/api/admin/teachers/3', '|', 'jq'],
            "admin_08_get_teacher.json",
            self.test_setup
        )
    ...
    def test_10_delete_teacher(self):
        ...
        self.run_api_test(
            10, "删除教师",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/admin/teachers/999', '|', 'jq'],
            "admin_10_delete_teacher.json",
            self.test_setup,
            expect_error=True
        )
    ...
    def test_18_get_subject(self):
        ...
        self.run_api_test(
            18, "获取特定科目",
            ['curl', '-s', f'{self.base_url}/api/admin/subjects/{subject_id}', '|', 'jq'],
            "admin_18_get_subject.json",
            self.test_setup
        )
    ...
    def test_20_delete_subject(self):
        ...
        self.run_api_test(
            20, "删除科目",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/admin/subjects/{subject_id}', '|', 'jq'],
            "admin_20_delete_subject.json",
            self.test_setup
        )
    ...
    def test_21_get_exam_types(self):
        ...
        self.run_api_test(
            21, "获取考试类型列表",
            ['curl', '-s', f'{self.base_url}/api/admin/exam-types', '|', 'jq'],
            "admin_21_get_exam_types.json",
            self.test_setup
        )
    ...
    def test_22_create_exam_type(self):
        ...
        self.run_api_test(
            ...
            ['curl', '-s', '-X', 'POST', f'{self.base_url}/api/admin/exam-types',
             '-H', 'Content-Type: application/json',
             '-d', '{"exam_type_name": "新考试类型1"}',
             '|', 'jq'],
            "admin_22_create_exam_type.json",
            self.test_setup
        )
    ...
    def test_23_get_exam_type(self):
        ...
        self.run_api_test(
            23, "获取特定考试类型",
            ['curl', '-s', f'{self.base_url}/api/admin/exam-types/2', '|', 'jq'],
            "admin_23_get_exam_type.json",
            self.test_setup
        )
    ...
    def test_24_update_exam_type(self):
        ...
        self.run_api_test(
            ...
            ['curl', '-s', '-X', 'PUT', f'{self.base_url}/api/admin/exam-types/2',
             ...
             '|', 'jq'],
            "admin_24_update_exam_type.json",
            self.test_setup
        )
    ...
    def test_25_delete_exam_type(self):
        ...
        self.run_api_test(
            25, "删除考试类型",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/admin/exam-types/2', '|', 'jq'],
            "admin_25_delete_exam_type.json",
            self.test_setup
        )
    ...
    def test_26_get_teacher_classes(self):
        ...
        self.run_api_test(
            26, "获取教师班级关系列表",
            ['curl', '-s', f'{self.base_url}/api/admin/teacher-classes', '|', 'jq'],
            "admin_26_get_teacher_classes.json",
            self.test_setup
        )
    ...
    def test_27_create_teacher_class(self):
        ...
        self.run_api_test(
            ...
            ['curl', '-s', '-X', 'POST', f'{self.base_url}/api/admin/teacher-classes',
             ...
             '|', 'jq'],
            "admin_27_create_teacher_class.json",
            self.test_setup
        )
    ...
    def test_28_get_teacher_class(self):
        ...
        self.run_api_test(
            28, "获取特定教师班级关系",
            ['curl', '-s', f'{self.base_url}/api/admin/teacher-classes/1', '|', 'jq'],
            "admin_28_get_teacher_class.json",
            self.test_setup
        )
    ...
    def test_29_update_teacher_class(self):
        ...
        self.run_api_test(
            ...
            ['curl', '-s', '-X', 'PUT', f'{self.base_url}/api/admin/teacher-classes/1',
             ...
             '-d', '{"teacher_id": 4, "class_id": 2}',
             '|', 'jq'],
            "admin_29_update_teacher_class.json",
            self.test_setup
        )
    ...
    def test_30_delete_teacher_class(self):
        ...
        self.run_api_test(
            30, "删除教师班级关系",
            ['curl', '-s', '-X', 'DELETE', f'{self.base_url}/api/admin/teacher-classes/4?class_id=2', '|', 'jq'],
            "admin_30_delete_teacher_class.json",
            self.test_setup
        )