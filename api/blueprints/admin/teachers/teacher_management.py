...
def get_teachers():
    ...
    try:
        ...
        current_app.logger.info('Retrieved teacher list')
...
def create_teacher():
    ...
    try:
        ...
        current_app.logger.info(f'Created teacher: {new_teacher_id}')
...
def get_teacher(teacher_id):
    ...
    try:
        ...
        current_app.logger.info(f'Retrieved teacher: {teacher_id}')
...
def update_teacher(teacher_id):
    ...
    try:
        ...
        current_app.logger.info(f'Updated teacher: {teacher_id}')
...
def delete_teacher(teacher_id):
    ...
    try:
        ...
        current_app.logger.info(f'Deleted teacher: {teacher_id}')
