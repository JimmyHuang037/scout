...
admin_teacher_detail_bp = Blueprint('admin_teacher_detail', __name__, url_prefix='/api/admin')

@admin_teacher_detail_bp.route('/teachers/<int:teacher_id>', methods=['GET'])
...
@admin_teacher_detail_bp.route('/teachers/<int:teacher_id>', methods=['PUT'])
...
@admin_teacher_detail_bp.route('/teachers/<int:teacher_id>', methods=['DELETE'])
