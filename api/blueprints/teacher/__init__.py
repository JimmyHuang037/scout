...
from .scores.score_management import create_score, update_score, delete_score, get_exam_scores
...
teacher_bp.add_url_rule('/exam-classes', view_func=get_teacher_classes, methods=['GET'])
teacher_bp.add_url_rule('/exam-results', view_func=lambda: get_exam_results(None), methods=['GET'])
...
teacher_bp.add_url_rule('/scores', view_func=lambda: get_exam_scores(None), methods=['GET'])
