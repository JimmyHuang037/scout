...
teacher_bp.add_url_rule('/teachers/<int:teacher_id>', view_func=get_teacher, methods=['GET'])
teacher_bp.add_url_rule('/teachers/<int:teacher_id>', view_func=update_teacher, methods=['PUT'])
teacher_bp.add_url_rule('/teachers/<int:teacher_id>', view_func=delete_teacher, methods=['DELETE'])