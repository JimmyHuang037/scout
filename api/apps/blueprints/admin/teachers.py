...
admin_teachers_bp.add_url_rule('/<int:teacher_id>', view_func=update_teacher, methods=['PUT'])
admin_teachers_bp.add_url_rule('/<int:teacher_id>', view_func=delete_teacher, methods=['DELETE'])