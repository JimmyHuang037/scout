...
# 教师个人资料管理蓝图
teacher_profile_bp = Blueprint('teacher_profile', __name__, url_prefix='/profile')
...
# 注册路由
teacher_profile_bp.add_url_rule('/<string:teacher_id>', view_func=get_teacher_profile, methods=['GET'])