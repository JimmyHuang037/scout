...
teacher_bp.add_url_rule('/students/<int:student_id>', view_func=get_teacher_student, methods=['GET'])
teacher_bp.add_url_rule('/students/<int:student_id>', view_func=update_teacher_student, methods=['PUT'])
...
teacher_bp.add_url_rule('/exams/<int:exam_id>/scores', view_func=get_exam_scores, methods=['GET'])
